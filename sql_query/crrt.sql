WITH crrt_settings AS (
    SELECT ce.stay_id,
        ...
        CASE
            ...
            ELSE NULL
        END AS accesspressure -- (ml/min)
,
        CASE
            WHEN ce.itemid = 224144 THEN ce.valuenum
            ELSE NULL
        END AS bloodflow -- (ACD-A)
,
        CASE
        ...
        CASE
            ...
            ELSE NULL
        END AS filterpressure -- (units/mL)
,
        CASE
            WHEN ce.itemid = 225958 THEN ce.value
            ELSE NULL
        END AS heparinconcentration -- (per hour)
,
        CASE
            WHEN ce.itemid = 224145 THEN ce.valuenum
            ELSE NULL
        END AS heparindose -- below may not account for drug infusion,
...
,
        ...
        END AS ultrafiltrateoutput -- separate system integrity into sub components
